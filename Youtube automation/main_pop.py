...
class open_csv():
    def __init__(self):
        ...
        self.path = '/Users/Stephanie/Desktop/pop_yt_file.csv'
...
class youtube_search():
    ...
    def search(self, data):
        ...
        for i in range (data.shape[0]):
            ...
            self.keywords = data.iloc[i,1] + " " + data.iloc[i,col_num-1] #for pop music
            ...
            # Grab the title of that video, don't delete in case we want to use it one day
            # title = buttom.get_attribute('title')  
